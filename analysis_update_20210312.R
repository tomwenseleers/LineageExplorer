...
dat="2021_03_12" # desired file version for Belgian data (date/path in //data)
...
# 501Y.V1 (British)               18698 0.7250116 0.01952194 NA 0.6867493 0.7632739      2021-03-12
...
#            variant collection_date_num      prob       SE df asymp.LCL asymp.UCL collection_date
# 2241 501Y.V1+V2+V3               18698 0.8453399 0.01031157 NA 0.8251296 0.8655502      2021-03-12

# estimated proportion of one of the three VOCs among new infections today (counted one week before lab diagnosis)
be_seq_mfit0_preds2[be_seq_mfit0_preds2$collection_date==(today+7)&
                      be_seq_mfit0_preds2$variant=="501Y.V1+V2+V3",]
#            variant collection_date_num      prob       SE df asymp.LCL asymp.UCL collection_date
# 2241 501Y.V1+V2+V3               18705 0.8932314 0.009039761 NA 0.8755138  0.910949      2021-03-19

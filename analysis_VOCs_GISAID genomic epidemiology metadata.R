...
# new cases for different states, I should write this code in a generic way :-)
cases_india_bystate_M = cases_india_bystate[cases_india_bystate$State=="Maharashtra",] 
cases_india_bystate_C = cases_india_bystate[cases_india_bystate$State=="Chhattisgarh",]
cases_india_bystate_G = cases_india_bystate[cases_india_bystate$State=="Gujarat",]
cases_india_bystate_WB = cases_india_bystate[cases_india_bystate$State=="West Bengal",]
cases_india_bystate_T = cases_india_bystate[cases_india_bystate$State=="Telangana",]
cases_india_bystate_AP = cases_india_bystate[cases_india_bystate$State=="Andhra Pradesh",]
...
cases_india_bystate_C$newcases = c(0,diff(cases_india_bystate_C$Confirmed))
cases_india_bystate_G$newcases = c(0,diff(cases_india_bystate_G$Confirmed))
cases_india_bystate_WB$newcases = c(0,diff(cases_india_bystate_WB$Confirmed))
cases_india_bystate_T$newcases = c(0,diff(cases_india_bystate_T$Confirmed))
cases_india_bystate_AP$newcases = c(0,diff(cases_india_bystate_AP$Confirmed))
cases_india_bystate_K$newcases = c(0,diff(cases_india_bystate_K$Confirmed))

cases_india_bystate2 = rbind(cases_india_bystate_M, cases_india_bystate_C, cases_india_bystate_G, 
                             cases_india_bystate_WB, cases_india_bystate_T, cases_india_bystate_AP,
                             cases_india_bystate_K)
cases_india_bystate2$STATE = factor(cases_india_bystate2$State, levels=levels_STATES)
cases_india_bystate2$propB16171 = 
cases_india_bystate2$propB16172 = 
...
ggplot(data=fit_india_multi_predsbystate, 

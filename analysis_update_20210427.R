...
dat="2021_04_23" # desired file version for Belgian data (date/path in //data)
...
head(be_seqdata)
range(be_seqdata$collection_date) # "2020-12-03" "2021-04-15"
...
# 501Y.V1 - wild type 0.05988119 0.05760863 0.06215375
# 501Y.V2 - wild type 0.03982818 0.03591108 0.04374529
# 501Y.V3 - wild type 0.06953700 0.06329900 0.07577499
...
# 501Y.V1 - wild type  0.05988 0.00116 NA  51.644 <.0001 
# 501Y.V2 - wild type  0.03983 0.00200 NA  19.928 <.0001 
# 501Y.V2 - 501Y.V1   -0.02005 0.00190 NA -10.559 <.0001 
# 501Y.V3 - wild type  0.06954 0.00318 NA  21.848 <.0001 
# 501Y.V3 - 501Y.V1    0.00966 0.00306 NA   3.160 0.0086 
# 501Y.V3 - 501Y.V2    0.02971 0.00351 NA   8.463 <.0001 
# 
...
# 501Y.V2 - 501Y.V1   -0.02005 0.00190 NA -10.559 <.0001 
# 501Y.V3 - wild type  0.06954 0.00318 NA  21.848 <.0001 
# 501Y.V3 - 501Y.V1    0.00966 0.00306 NA   3.160 0.0016 
# 501Y.V3 - 501Y.V2    0.02971 0.00351 NA   8.463 <.0001
# 
# Degrees-of-freedom method: user-specified 
...
# estimate asymp.LCL asymp.UCL
# 501Y.V1 - wild type 1.325039  1.310961  1.339267
# 501Y.V2 - wild type 1.205859  1.183862  1.228265
# 501Y.V3 - wild type 1.386557  1.346496  1.427811
...
delta_r_allVOCs
#                               estimate  asymp.LCL  asymp.UCL
# (501Y.V1+V2+V3) - wild type 0.05813136 0.05592151 0.0603412

# implied transmission advantage (assuming no immune evasion advantage of 501Y.V2, if there is such an advantage, transm advantage would be less)
exp(delta_r_allVOCs*4.7) 
#                             estimate asymp.LCL asymp.UCL
# (501Y.V1+V2+V3) - wild type   1.314186  1.300607  1.327907
...
# 501Y.V1 (British)               18743 0.9009015 0.008145627 NA 0.8849363 0.9168666      2021-04-26
...
be_seq_mfit0_preds2[be_seq_mfit0_preds2$collection_date==(today+7)&
                      be_seq_mfit0_preds2$variant=="501Y.V1 (British)",]
#            variant collection_date_num      prob       SE df asymp.LCL asymp.UCL collection_date
# 501Y.V1 (British)               18750 0.9047108 0.009667449 NA 0.8857629 0.9236586      2021-05-03

# estimated proportion of 501Y.V2 among new lab diagnoses today
be_seq_mfit0_preds2[be_seq_mfit0_preds2$collection_date==today&
                      be_seq_mfit0_preds2$variant=="501Y.V2 (South African)",]
#            variant collection_date_num      prob       SE df asymp.LCL asymp.UCL collection_date
# 501Y.V2 (South African)               18743 0.02825206 0.003006899 NA 0.02235865 0.03414547      2021-04-26

# estimated proportion of 501Y.V2 among new infections today (counted one week before lab diagnosis)
be_seq_mfit0_preds2[be_seq_mfit0_preds2$collection_date==(today+7)&
                      be_seq_mfit0_preds2$variant=="501Y.V2 (South African)",]
#            variant collection_date_num      prob       SE df asymp.LCL asymp.UCL collection_date
# 501Y.V2 (South African)               18750 0.02465586 0.002934265 NA 0.01890481 0.03040692      2021-05-03

# estimated proportion of 501Y.V3 among new lab diagnoses today
be_seq_mfit0_preds2[be_seq_mfit0_preds2$collection_date==today&
                      be_seq_mfit0_preds2$variant=="501Y.V3 (Brazilian)",]
#            variant collection_date_num      prob       SE df asymp.LCL asymp.UCL collection_date
# 501Y.V3 (Brazilian)               18743 0.05759356 0.007681235 NA 0.04253862 0.07264851      2021-04-26

# estimated proportion of 501Y.V3 among new infections today (counted one week before lab diagnosis)
be_seq_mfit0_preds2[be_seq_mfit0_preds2$collection_date==(today+7)&
                      be_seq_mfit0_preds2$variant=="501Y.V3 (Brazilian)",]
#            variant collection_date_num      prob       SE df asymp.LCL asymp.UCL collection_date
# 501Y.V3 (Brazilian)                18750 0.06188147 0.009366802 NA 0.04352288 0.08024007      2021-05-03
...
#            variant collection_date_num      prob       SE df asymp.LCL asymp.UCL collection_date
# 2241 501Y.V1+V2+V3               18743 0.9859777 0.001029505 NA 0.9839599 0.9879955      2021-04-26

# estimated proportion of one of the three VOCs among new infections today (counted one week before lab diagnosis)
be_seq_mfit0_preds2[be_seq_mfit0_preds2$collection_date==(today+7)&
                      be_seq_mfit0_preds2$variant=="501Y.V1+V2+V3",]
#            variant collection_date_num      prob       SE df asymp.LCL asymp.UCL collection_date
# 2241 501Y.V1+V2+V3               18750 0.9906214 0.0007619872 NA 0.9891279 0.9921149      2021-05-03
...
# >90% by 22nd of March [21st March - 23d of March] 95% CLs
...
# >90% by 15th of March [14th March - 16th of March] 95% CLs

...
muller_spain_raw2 = ggplot(data=data_agbyweek2, aes(x=collection_date, y=count, group=LINEAGE2)) + 
...
fit_spain_multi_preds$collection_date = as.Date(fit_spain_multi_preds$DATE_NUM, origin="1970-01-01")
fit_spain_multi_preds$LINEAGE2 = factor(fit_spain_multi_preds$LINEAGE2, levels=levels_LINEAGE2) 

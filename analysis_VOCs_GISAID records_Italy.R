# ANALYSIS OF GROWTH ADVANTAGE OF DIFFERENT VOCs IN ITALY (GISAID RECORDS)
# T. Wenseleers
# last update 7 OCTOBER 2021
  ...
  plotdir = "Italy_GISAID"
  suppressWarnings(dir.create(paste0(".//plots//",plotdir)))

# import GISAID records for Italy
d1 = read_tsv(file(".//data//GISAID//Italy//gisaid_hcov-19_2021_10_08_22_subm_2020.tsv"), col_types = cols(.default = "c")) 
d2 = read_tsv(file(".//data//GISAID//Italy//gisaid_hcov-19_2021_10_08_22_subm_jan_feb_2021.tsv"), col_types = cols(.default = "c")) 
d3 = read_tsv(file(".//data//GISAID//Italy//gisaid_hcov-19_2021_10_08_22_subm_mar_2021.tsv"), col_types = cols(.default = "c")) 
d4 = read_tsv(file(".//data//GISAID//Italy//gisaid_hcov-19_2021_10_08_22_subm_apr_2021.tsv"), col_types = cols(.default = "c")) 
d5 = read_tsv(file(".//data//GISAID//Italy//gisaid_hcov-19_2021_10_08_22_subm_may_2021.tsv"), col_types = cols(.default = "c")) 
d6 = read_tsv(file(".//data//GISAID//Italy//gisaid_hcov-19_2021_10_08_22_subm_june_2021.tsv"), col_types = cols(.default = "c")) 
d7 = read_tsv(file(".//data//GISAID//Italy//gisaid_hcov-19_2021_10_08_22_subm_july_2021.tsv"), col_types = cols(.default = "c")) 
d8 = read_tsv(file(".//data//GISAID//Italy//gisaid_hcov-19_2021_10_08_22_subm_aug_2021.tsv"), col_types = cols(.default = "c")) 
d9 = read_tsv(file(".//data//GISAID//Italy//gisaid_hcov-19_2021_10_08_22_subm_sept_2021.tsv"), col_types = cols(.default = "c")) 
d10 = read_tsv(file(".//data//GISAID//Italy//gisaid_hcov-19_2021_10_08_22_subm_oct_2021.tsv"), col_types = cols(.default = "c")) 
GISAID = as.data.frame(rbind(d1, d2, d3, d4, d5, d6, d7, d8, d9, d10))
...
range(GISAID$date) # "2021-01-01" "2021-10-05"
...
GISAID = GISAID[!is.na(GISAID$pango_lineage),]
...
GISAID$pango_lineage[grepl("P.1\\>",GISAID$pango_lineage)] = "P.1+"
...
sum(GISAID_sel$LINEAGE==sel_target_VOC) # 9075
...
main_lineages
# "AY.34"      "AY.4"       "AY.7.2"     "B.1.1.7"    "B.1.177+"   "B.1.258.14" "B.1.617.2"  "P.1+"      "Q.2" 
VOCs = c("B.1.617.1","B.1.617.2","B.1.617+","B.1.618","B.1.1.7","B.1.351","P.1","P.1+","B.1.1.318","B.1.1.207","B.1.429",
...
remove = unique(c(names(table(GISAID_sel$LINEAGE))[table(GISAID_sel$LINEAGE)/sum(table(GISAID_sel$LINEAGE)) < 0.0005],
                  names(table(GISAID_sel$LINEAGE))[table(GISAID_sel$LINEAGE) < 100]))
remove = remove[!(remove %in% c("B.1.351","B.1.1.7","P.1","B.1.617.2","B.1.617.1","B.1.621+",sel_target_VOC,"B.1.351","P.1+","AY.4"))]
...
# "B.1.1.7"    "AY.21"      "AY.26"      "AY.33"      "AY.34"      "AY.4"       "AY.5"       "AY.6"       "AY.7.2"     "AY.9"      
# "B.1.177+"   "B.1.258.14" "B.1.351"    "B.1.525"    "B.1.617.1"  "B.1.617.2"  "B.1.621+"   "other"      "P.1+"     
# "Q.2" 

levels_LINEAGE = c("B.1.1.7","B.1.177+","B.1.258.14","B.1.351","B.1.525","B.1.621+","P.1+","Q.2","B.1.617.1",
                    sel_target_VOC,"AY.4","AY.5","AY.6","AY.7.2","AY.9","AY.21","AY.26","AY.33","AY.34",
                    "other")
...
# Spike_D950B more common in AY.34 than in B.1.617.2
# Spike_D950N & D614G & G142D less common in AY.34 than in B.1.617.2

#            Var1 lineage.x    Freq.x lineage.y     Freq.y
# 64       N_D63G     AY.34 0.9962806 B.1.617.2 0.83173554
# 557 NSP3_P1228L     AY.34 0.9787460 B.1.617.2 0.71261708
# 559 NSP3_P1469S     AY.34 0.9750266 B.1.617.2 0.68396694
# 515  NSP3_A488S     AY.34 0.9713071 B.1.617.2 0.70831956
# 672   NSP6_T77A     AY.34 0.9697131 B.1.617.2 0.70578512
# 3      (N_G215C     AY.34 0.9144527 B.1.617.2 0.67041322
# 640  NSP4_T492I     AY.34 0.8092455 B.1.617.2 0.70512397
# 355  NSP13_P77L     AY.34 0.8065887 B.1.617.2 0.98104683
# 732 Spike_D950B     AY.34 0.6886291 B.1.617.2 0.01101928
# 214  NS7a_T120I     AY.34 0.6732200 B.1.617.2 0.95955923
# 786 Spike_P681R     AY.34 0.5812965 B.1.617.2 0.99206612
# 225   NS7b_T40I     AY.34 0.4941552 B.1.617.2 0.69696970
# 733 Spike_D950N     AY.34 0.2991498 B.1.617.2 0.90170799
# 728 Spike_D614G     AY.34 0.2460149 B.1.617.2 0.98997245
# 372 NSP14_A394V     AY.34 0.2422954 B.1.617.2 0.70225895
# 643  NSP4_V167L     AY.34 0.1880978 B.1.617.2 0.63702479
# 220   NS7a_V82A     AY.34 0.1790648 B.1.617.2 0.96517906
# 34       M_I82T     AY.34 0.1710946 B.1.617.2 0.99283747
# 745 Spike_G142D     AY.34 0.1386823 B.1.617.2 0.82170799
...
# MULLER PLOT (RAW DATA)
  ...
  lineage_cols2[which(levels(GISAID_sel$LINEAGE)=="AY.4")] = muted("red",c=150,l=80)
  lineage_cols2[which(levels(GISAID_sel$LINEAGE)=="AY.5")] = muted("red",c=150,l=70)
  lineage_cols2[which(levels(GISAID_sel$LINEAGE)=="AY.6")] = muted("red",c=150,l=60)
  lineage_cols2[which(levels(GISAID_sel$LINEAGE)=="AY.7.2")] = muted("red",c=150,l=50)
  lineage_cols2[which(levels(GISAID_sel$LINEAGE)=="AY.9")] = muted("red",c=150,l=40)
  lineage_cols2[which(levels(GISAID_sel$LINEAGE)=="AY.21")] = muted("red",c=150,l=30)
  lineage_cols2[which(levels(GISAID_sel$LINEAGE)=="AY.26")] = muted("red",c=150,l=20)
  lineage_cols2[which(levels(GISAID_sel$LINEAGE)=="AY.30")] = muted("red",c=150,l=10)
  lineage_cols2[which(levels(GISAID_sel$LINEAGE)=="AY.33")] = muted("red",c=150,l=5)
  lineage_cols2[which(levels(GISAID_sel$LINEAGE)=="AY.34")] = "blue"
  lineage_cols2[which(levels(GISAID_sel$LINEAGE)=="other")] = "grey75"

muller_italy_raw2 = ggplot(data=data_agbyweek, aes(x=collection_date, y=count, group=LINEAGE)) + 
  ...
  labs(title = "SPREAD OF SARS-CoV2 VARIANTS OF CONCERN IN ITALY\n(GISAID data)") 
# +
# coord_cartesian(xlim=c(1,max(GISAID_sel$Week)))
muller_italy_raw2

ggsave(file=paste0(".\\plots\\",plotdir,"\\italy_muller plots_raw data.png"), width=8, height=6)
# ggsave(file=paste0(".\\plots\\",plotdir,"\\italy_muller plots_raw data.pdf"), width=8, height=6)
...
library(splines)
set.seed(1)
fit1_italy_multi = nnet::multinom(LINEAGE ~ scale(DATE_NUM), weights=count, data=data_agbyweek, maxit=1000)
fit2_italy_multi = nnet::multinom(LINEAGE ~ ns(DATE_NUM, df=2), weights=count, data=data_agbyweek, maxit=1000)
fit3_italy_multi = nnet::multinom(LINEAGE ~ ns(DATE_NUM, df=3), weights=count, data=data_agbyweek, maxit=1000)
BIC(fit1_italy_multi, fit2_italy_multi, fit3_italy_multi) 
# df      BIC
# fit1_italy_multi 38 154492.1
# fit2_italy_multi 57 148713.5
# fit3_italy_multi 76 148099.3

# growth rate advantage compared to Delta (difference in growth rate per day) 
emtritaly = emtrends(fit2_italy_multi, trt.vs.ctrl ~ LINEAGE,  
                   var="DATE_NUM",  mode="latent",
                   at=list(DATE_NUM=max(GISAID_sel$DATE_NUM)),
                   adjust="none", df=NA)
delta_r_italy = data.frame(confint(emtritaly, 
                                 adjust="none", df=NA)$contrasts, 
                         p.value=as.data.frame(emtritaly$contrasts,
                                               adjust="none", df=NA)$p.value)
delta_r_italy
# contrast     estimate           SE df    asymp.LCL    asymp.UCL       p.value
# 1     B.1.1.7 - B.1.617.2 -0.112774941 0.0018098598 NA -0.116322201 -0.109227681  0.000000e+00
# 2  (B.1.177+) - B.1.617.2 -0.119892618 0.0098273012 NA -0.139153774 -0.100631461  3.110015e-34
# 3  B.1.258.14 - B.1.617.2 -0.283233178 0.0457868749 NA -0.372973804 -0.193492552  6.174787e-10
# 4     B.1.351 - B.1.617.2 -0.089075487 0.0142210341 NA -0.116948201 -0.061202772  3.760849e-10
# 5     B.1.525 - B.1.617.2 -0.122445960 0.0068495401 NA -0.135870812 -0.109021108  1.797008e-71
# 6  (B.1.621+) - B.1.617.2 -0.128893739 0.0152976863 NA -0.158876653 -0.098910825  3.585952e-17
# 7      (P.1+) - B.1.617.2 -0.081220023 0.0022767410 NA -0.085682354 -0.076757693 1.007395e-278
# 8         Q.2 - B.1.617.2 -0.151983453 0.0049869184 NA -0.161757634 -0.142209273 5.350800e-204
# 9   B.1.617.1 - B.1.617.2 -0.257971787 0.0607100560 NA -0.376961311 -0.138982264  2.144940e-05
# 10       AY.4 - B.1.617.2 -0.004547019 0.0008889807 NA -0.006289390 -0.002804649  3.139590e-07
# 11       AY.5 - B.1.617.2  0.013747499 0.0027148932 NA  0.008426406  0.019068592  4.111213e-07
# 12       AY.6 - B.1.617.2 -0.049338533 0.0065729166 NA -0.062221213 -0.036455853  6.080434e-14
# 13     AY.7.2 - B.1.617.2 -0.108078461 0.0086259991 NA -0.124985109 -0.091171814  5.156114e-36
# 14       AY.9 - B.1.617.2 -0.001276050 0.0025133843 NA -0.006202192  0.003650093  6.116625e-01
# 15      AY.21 - B.1.617.2 -0.226603324 0.0232872707 NA -0.272245536 -0.180961112  2.228757e-22
# 16      AY.26 - B.1.617.2  0.001995984 0.0021898583 NA -0.002296059  0.006288028  3.620492e-01
# 17      AY.33 - B.1.617.2  0.014764999 0.0036246923 NA  0.007660732  0.021869265  4.632203e-05
# 18      AY.34 - B.1.617.2 -0.011611532 0.0023254133 NA -0.016169258 -0.007053805  5.935023e-07
# 19      other - B.1.617.2 -0.012771830 0.0012281397 NA -0.015178939 -0.010364720  2.496831e-25
  
# AY.34 5.6% less infectious than B.1.617.2 with GT of 4.7 days
exp(0.011611532*4.7) # = 1.056

# fitted prop of different LINEAGES in the italy today
multinom_preds_today_avg = data.frame(emmeans(fit2_italy_multi, ~ LINEAGE|1,
                                              at=list(DATE_NUM=today_num), 
                                              mode="prob", df=NA))
multinom_preds_today_avg
# LINEAGE         prob           SE df     asymp.LCL    asymp.UCL
# 1   B.1.617.2 4.801028e-01 1.037759e-02 NA  4.597630e-01 5.004425e-01
# 2     B.1.1.7 1.502619e-05 2.329201e-06 NA  1.046104e-05 1.959134e-05
# 3    B.1.177+ 6.463393e-09 8.101132e-09 NA -9.414535e-09 2.234132e-08
# 4  B.1.258.14 3.354672e-19 2.045039e-18 NA -3.672735e-18 4.343669e-18
# 5     B.1.351 3.414169e-07 5.129516e-07 NA -6.639498e-07 1.346784e-06
# 6     B.1.525 1.271684e-07 9.099574e-08 NA -5.117995e-08 3.055168e-07
# 7    B.1.621+ 1.620868e-07 2.047670e-07 NA -2.392490e-07 5.634227e-07
# 8        P.1+ 7.011651e-05 1.412974e-05 NA  4.242273e-05 9.781029e-05
# 9         Q.2 1.189840e-08 6.477649e-09 NA -7.975541e-10 2.459436e-08
# 10  B.1.617.1 8.543267e-14 4.994244e-13 NA -8.934212e-13 1.064287e-12
# 11       AY.4 2.572787e-01 8.772248e-03 NA  2.400854e-01 2.744720e-01
# 12       AY.5 4.136166e-02 4.958319e-03 NA  3.164354e-02 5.107979e-02
# 13       AY.6 5.269249e-03 1.307310e-03 NA  2.706968e-03 7.831531e-03
# 14     AY.7.2 5.098638e-04 1.855414e-04 NA  1.462094e-04 8.735182e-04
# 15       AY.9 2.368833e-02 3.078464e-03 NA  1.765465e-02 2.972201e-02
# 16      AY.21 3.211018e-08 4.355881e-08 NA -5.326352e-08 1.174839e-07
# 17      AY.26 2.741057e-02 3.277808e-03 NA  2.098619e-02 3.383496e-02
# 18      AY.33 3.253506e-02 4.719631e-03 NA  2.328475e-02 4.178536e-02
# 19      AY.34 1.048291e-01 7.733513e-03 NA  8.967166e-02 1.199865e-01
# 20      other 2.692891e-02 2.216605e-03 NA  2.258444e-02 3.127337e-02
...
fit_italy_multi_preds = data.frame(predgrid, as.data.frame(predict(fit2_italy_multi, newdata=predgrid, type="prob")),check.names=F)
library(tidyr)
library(tidyselect)
fit_italy_multi_preds = gather(fit_italy_multi_preds, LINEAGE, prob, all_of(levels_LINEAGE), factor_key=TRUE)
fit_italy_multi_preds$collection_date = as.Date(fit_italy_multi_preds$DATE_NUM, origin="1970-01-01")
fit_italy_multi_preds$LINEAGE = factor(fit_italy_multi_preds$LINEAGE, levels=levels_LINEAGE) 

muller_italy_mfit = ggplot(data=fit_italy_multi_preds, 
  ...
  theme_hc() + theme(legend.position="right", 
                     axis.title.x=element_blank()) + 
  ylab("Share") +
  ggtitle("SPREAD OF SARS-CoV2 VARIANTS OF CONCERN IN ITALY\n(GISAID data, multinomial fit)")
muller_italy_mfit

ggsave(file=paste0(".\\plots\\",plotdir,"\\italy_muller plots_multinom fit.png"), width=10, height=6)
# ggsave(file=paste0(".\\plots\\",plotdir,"\\italy_muller plots_multinom fit.pdf"), width=10, height=6)


library(ggpubr)
ggarrange(muller_italy_raw2 + coord_cartesian(xlim=c(as.Date("2021-01-01"),as.Date(date.to, origin="1970-01-01")))+
            theme(legend.background = element_rect(fill = alpha("white", 0)),
                  legend.key = element_rect(fill = alpha("white", 0)),
                  legend.text=element_text(color = "white")) +
            guides(colour = guide_legend(override.aes = list(alpha = 0)),
                   fill = guide_legend(override.aes = list(alpha = 0))), 
          muller_italy_mfit+ggtitle("Multinomial fit"), ncol=1)

ggsave(file=paste0(".\\plots\\",plotdir,"\\italy_muller plots multipanel_multinom fit.png"), width=10, height=10)
# ggsave(file=paste0(".\\plots\\",plotdir,"\\italy_muller plots multipanel_multinom fit.pdf"), width=10, height=10)
...
fit_italy_multi_preds_withCI = data.frame(emmeans(fit2_italy_multi,
                                                        ~ LINEAGE,
                                                        by=c("DATE_NUM"),
                                                        at=list(DATE_NUM=seq(date.from, date.to, by=2)),  # by=XX to speed up things a bit
                                                        mode="prob", df=NA))
fit_italy_multi_preds_withCI$collection_date = as.Date(fit_italy_multi_preds_withCI$DATE_NUM, origin="1970-01-01")
fit_italy_multi_preds_withCI$LINEAGE = factor(fit_italy_multi_preds_withCI$LINEAGE, levels=levels_LINEAGE)
fit_italy_multi_preds2 = fit_italy_multi_preds_withCI
...
ymin = 0.001
ymax = 0.999
fit_italy_multi_preds2$asymp.LCL[fit_italy_multi_preds2$asymp.LCL<ymin] = ymin
fit_italy_multi_preds2$asymp.UCL[fit_italy_multi_preds2$asymp.UCL<ymin] = ymin
fit_italy_multi_preds2$asymp.UCL[fit_italy_multi_preds2$asymp.UCL>ymax] = ymax
fit_italy_multi_preds2$prob[fit_italy_multi_preds2$prob<ymin] = ymin

plot_italy_mfit_logit = qplot(data=fit_italy_multi_preds2, x=collection_date, y=prob, geom="blank") +
  # facet_wrap(~ STATE) +
...
plot_italy_mfit_logit

ggsave(file=paste0(".\\plots\\",plotdir,"\\italy_multinom fit_logit scale.png"), width=10, height=6)
# ggsave(file=paste0(".\\plots\\",plotdir,"\\italy_multinom fit_logit scale.pdf"), width=10, height=6)


# on response scale:
plot_italy_mfit = qplot(data=fit_italy_multi_preds2, x=collection_date, y=100*prob, geom="blank") +
  # facet_wrap(~ STATE) +
...
ggsave(file=paste0(".\\plots\\",plotdir,"\\italy_multinom fit_response scale.png"), width=10, height=6)
# ggsave(file=paste0(".\\plots\\",plotdir,"\\italy_multinom fit_response scale.pdf"), width=10, height=6)
...
cases_tot = as.data.frame(get_national_data(countries = "Italy"))
...
fit_italy_multi_preds_withCI$totcases = cases_tot$cases_new[match(round(fit_italy_multi_preds_withCI$DATE_NUM),cases_tot$DATE_NUM)]
fit_italy_multi_preds_withCI$cases = fit_italy_multi_preds_withCI$totcases * fit_italy_multi_preds_withCI$prob
fit_italy_multi_preds_withCI$cases[fit_italy_multi_preds_withCI$cases<=0.001] = NA
...
fit_italy_multi_preds_withCI$smoothed_totcases = cases_emmeans$rate[match(fit_italy_multi_preds_withCI$DATE_NUM,cases_emmeans$DATE_NUM)]
fit_italy_multi_preds_withCI$smoothed_cases = fit_italy_multi_preds_withCI$smoothed_totcases * fit_italy_multi_preds_withCI$prob
fit_italy_multi_preds_withCI$smoothed_cases[fit_italy_multi_preds_withCI$smoothed_cases<=0.001] = NA
fit_italy_multi_preds_withCI$LINEAGE = factor(fit_italy_multi_preds_withCI$LINEAGE, levels=levels_LINEAGE)

ggplot(data=fit_italy_multi_preds_withCI[fit_italy_multi_preds_withCI$collection_date>=as.Date("2021-01-01"),], 
...
ggplot(data=fit_italy_multi_preds_withCI[fit_italy_multi_preds_withCI$collection_date>=as.Date("2021-01-01")&
                                              fit_italy_multi_preds_withCI$collection_date<=max(cases_tot$date),], 
...
qplot(data=avg_r_cases, x=DATE-7, y=Re, ymin=Re_LOWER, ymax=Re_UPPER, geom="ribbon", alpha=I(0.5), fill=I("steelblue")) +
  ...
  ggtitle("Re IN ITALY AT MOMENT OF INFECTION BASED ON NEW CASES") +
  # labs(tag = tag) +
...
above_avg_r_variants0 = do.call(rbind, lapply(seq(date.from,
                                                  date.to), 
                                              function (d) { 
                                                wt = as.data.frame(emmeans(fit2_italy_multi, ~ LINEAGE , at=list(DATE_NUM=d), type="response"))$prob   # important: these should sum to 1
                                                ...
                                                EMT = emtrends(fit2_italy_multi,  ~ LINEAGE , by=c("DATE_NUM"),
                                                               var="DATE_NUM", mode="latent",
                                                               at=list(DATE_NUM=d))
...
above_avg_r_variants$prob = fit_italy_multi_preds_withCI$prob[match(interaction(above_avg_r_variants$DATE_NUM,
                                                                      above_avg_r_variants$variant),
                                                          interaction(fit_italy_multi_preds_withCI$DATE_NUM,
                                                                      fit_italy_multi_preds_withCI$LINEAGE))]

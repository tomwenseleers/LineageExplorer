...
today # "2021-07-03"
plotdir = "India_GISAID"
suppressWarnings(dir.create(paste0(".//plots//",plotdir)))

# import GISAID metadata
# GISAID = read_tsv(gzfile(".//data//GISAID_genomic_epidemiology//metadata_2022-07-01_00-11.tsv.gz"), col_types = cols(.default = "c")) 
...
# range(GISAID$date) # "2019-12-24" "2021-06-24"
...
# firstBA_2_75 # BA.2 + Spike K147E & W152R 
...
range(GISAID$date) # "2020-06-01" "2021-06-24"
nrow(GISAID) # 10998076
...
levels_VARIANTS = c(sel_reference_VOC, "Beta", "Alpha", "Other", "Delta", "Omicron (BA.2)", "Omicron (BA.3)", "Omicron (BA.4)", "Omicron (BA.5)", sel_target_VOC)
levels_VARIANTS_plot = c("Other", "Beta", "Alpha", "Delta", "Omicron (BA.1)", "Omicron (BA.2)", "Omicron (BA.3)", "Omicron (BA.4)", "Omicron (BA.5)", "Omicron (BA.2.75)")

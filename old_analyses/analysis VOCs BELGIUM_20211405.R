...
# Data: weekly Sciensano report from the 14th of May 2021

# Tom Wenseleers, last update 14 MAY 2021
...
dat="2021_05_14" # desired file version for Belgian data (date/path in //data)
...
# data from weekly Sciensano report of 14/5/2021
...
# 501Y.V1 - wild type  0.02267609  0.01831965  0.02703254
# 501Y.V2 - wild type -0.02516790 -0.03432233 -0.01601347
# 501Y.V3 - wild type  0.02876385  0.02041925  0.03710846
...
# 501Y.V1 - wild type  0.02268 0.00222 NA  10.202 <.0001 
# 501Y.V2 - wild type -0.02517 0.00467 NA  -5.388 <.0001 
# 501Y.V2 - 501Y.V1   -0.04784 0.00438 NA -10.928 <.0001 
# 501Y.V3 - wild type  0.02876 0.00426 NA   6.756 <.0001 
# 501Y.V3 - 501Y.V1    0.00609 0.00375 NA   1.623 0.3657 
# 501Y.V3 - 501Y.V2    0.05393 0.00567 NA   9.505 <.0001 
# 
...
# 501Y.V1 - wild type  0.02268 0.00222 NA   0.01697    0.0284
# 501Y.V2 - wild type -0.02517 0.00467 NA  -0.03717   -0.0132
# 501Y.V2 - 501Y.V1   -0.04784 0.00438 NA  -0.05909   -0.0366
# 501Y.V3 - wild type  0.02876 0.00426 NA   0.01783    0.0397
# 501Y.V3 - 501Y.V1    0.00609 0.00375 NA  -0.00355    0.0157
# 501Y.V3 - 501Y.V2    0.05393 0.00567 NA   0.03935    0.0685
# 
# Degrees-of-freedom method: user-specified 
...
#                     estimate asymp.LCL asymp.UCL
# 501Y.V1 - wild type 1.1124643  1.089918 1.1354771
# 501Y.V2 - wild type 0.8884391  0.851024 0.9274992
# 501Y.V3 - wild type 1.1447544  1.100727 1.1905433
...
#   estimate asymp.LCL asymp.UCL
# 1 1.1124643 1.0830050 1.1427249
# 2 0.8884391 0.8397211 0.9399836
# 3 0.7986226 0.7575026 0.8419748
# 4 1.1447544 1.0873927 1.2051420
# 5 1.0290258 0.9834533 1.0767100
# 6 1.2885006 1.2031773 1.3798747
...
delta_r_allVOCs
#                               estimate  asymp.LCL  asymp.UCL
# (501Y.V1+V2+V3) - wild type 0.05976456 0.0572118 0.06231731

# implied transmission advantage (assuming no immune evasion advantage of 501Y.V2, if there is such an advantage, transm advantage would be less)
exp(delta_r_allVOCs*4.7) 
#                             estimate asymp.LCL asymp.UCL
# (501Y.V1+V2+V3) - wild type   1.324312  1.308518  1.340297

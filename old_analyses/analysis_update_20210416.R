...
head(be_seqdata)
range(be_seqdata$collection_date) # "2020-12-03" "2021-04-08"
...
# 501Y.V1 - wild type 0.06176218 0.05927081 0.06425355
# 501Y.V2 - wild type 0.04434449 0.04000583 0.04868315
# 501Y.V3 - wild type 0.06966489 0.06235029 0.07697949
...
# 501Y.V1 - wild type   0.0618 0.00127 NA 48.588  <.0001 
# 501Y.V2 - wild type   0.0443 0.00221 NA 20.032  <.0001 
# 501Y.V2 - 501Y.V1    -0.0174 0.00211 NA -8.237  <.0001 
# 501Y.V3 - wild type   0.0697 0.00373 NA 18.667  <.0001 
# 501Y.V3 - 501Y.V1     0.0079 0.00362 NA  2.183  0.1278 
# 501Y.V3 - 501Y.V2     0.0253 0.00409 NA  6.194  <.0001 
# 
...
# 501Y.V2 - 501Y.V1    -0.0174 0.00211 NA -8.237  <.0001 
# 501Y.V3 - wild type   0.0697 0.00373 NA 18.667  <.0001 
# 501Y.V3 - 501Y.V1     0.0079 0.00362 NA  2.183  0.0290 
# 501Y.V3 - 501Y.V2     0.0253 0.00409 NA  6.194  <.0001 
# 
# Degrees-of-freedom method: user-specified 
...
# estimate asymp.LCL asymp.UCL
# 501Y.V1 - wild type 1.336805  1.321243  1.352550
# 501Y.V2 - wild type 1.231729  1.206867  1.257104
# 501Y.V3 - wild type 1.387391  1.340505  1.435917
...
delta_r_allVOCs
#                               estimate  asymp.LCL  asymp.UCL
# (501Y.V1+V2+V3) - wild type 0.06013769 0.05771701 0.06255836

# implied transmission advantage (assuming no immune evasion advantage of 501Y.V2, if there is such an advantage, transm advantage would be less)
exp(delta_r_allVOCs*4.7) 
#                             estimate asymp.LCL asymp.UCL
# (501Y.V1+V2+V3) - wild type   1.326637  1.311629  1.341817
...
muller_be_seq_mfit0 = ggplot(data=be_seq_mfit0_preds, 
  ...
  annotate("rect", xmin=max(be_basseqdata_long$collection_date)+1, 
           xmax=as.Date("2021-04-30"), ymin=0, ymax=1, alpha=0.3, fill="white") + # extrapolated part
  scale_fill_manual("variant", values=c("grey75","red","blue","green3")) +
  scale_x_continuous(breaks=as.Date(c("2020-03-01","2020-04-01","2020-05-01","2020-06-01","2020-07-01","2020-08-01","2020-09-01","2020-10-01","2020-11-01","2020-12-01","2021-01-01","2021-02-01","2021-03-01","2021-04-01")),
                     labels=substring(months(as.Date(c("2020-03-01","2020-04-01","2020-05-01","2020-06-01","2020-07-01","2020-08-01","2020-09-01","2020-10-01","2020-11-01","2020-12-01","2021-01-01","2021-02-01","2021-03-01","2021-04-01"))),1,1),
                     limits=as.Date(c("2020-12-01","2021-04-30")), expand=c(0,0)) +
...
plot_multinom_501YV1_501YV2_501YV3_response = qplot(data=be_seq_mfit0_preds2, x=collection_date, y=100*prob, geom="blank") +
  ...
  coord_cartesian(xlim=c(min(be_basseqdata_long2$collection_date), as.Date("2021-05-01")),
...
plot_multinom_501YV1_501YV2_501YV3 = qplot(data=be_seq_mfit0_preds3, x=collection_date, y=prob, geom="blank") +
  ...
  theme(legend.position = "right") +
  xlab("Collection date")+
  coord_cartesian(xlim=c(as.Date("2021-01-01"),as.Date("2021-05-01")), ylim=c(0.001, 0.9900001), expand=c(0,0))
...
# 501Y.V1 (British)               18733 0.8912499 0.007801878 NA 0.8759585 0.9065413      2021-04-16
...
be_seq_mfit0_preds2[be_seq_mfit0_preds2$collection_date==(today+7)&
                      be_seq_mfit0_preds2$variant=="501Y.V1 (British)",]
#            variant collection_date_num      prob       SE df asymp.LCL asymp.UCL collection_date
# 501Y.V1 (British)               18740 0.8996881 0.009085714 NA 0.8818804 0.9174958      2021-04-23

# estimated proportion of 501Y.V2 among new lab diagnoses today
be_seq_mfit0_preds2[be_seq_mfit0_preds2$collection_date==today&
                      be_seq_mfit0_preds2$variant=="501Y.V2 (South African)",]
#            variant collection_date_num      prob       SE df asymp.LCL asymp.UCL collection_date
# 501Y.V2 (South African)               18733 0.04034623 0.004049176 NA 0.03240999 0.04828247      2021-04-16

# estimated proportion of 501Y.V2 among new infections today (counted one week before lab diagnosis)
be_seq_mfit0_preds2[be_seq_mfit0_preds2$collection_date==(today+7)&
                      be_seq_mfit0_preds2$variant=="501Y.V2 (South African)",]
#            variant collection_date_num      prob       SE df asymp.LCL asymp.UCL collection_date
# 501Y.V2 (South African)               18740 0.03605327 0.004112871 NA 0.02799219 0.04411435      2021-04-23

# estimated proportion of 501Y.V3 among new lab diagnoses today
be_seq_mfit0_preds2[be_seq_mfit0_preds2$collection_date==today&
                      be_seq_mfit0_preds2$variant=="501Y.V3 (Brazilian)",]
#            variant collection_date_num      prob       SE df asymp.LCL asymp.UCL collection_date
# 501Y.V3 (Brazilian)               18733 0.04722484 0.006701841 NA 0.03408948 0.06036021      2021-04-16

# estimated proportion of 501Y.V3 among new infections today (counted one week before lab diagnosis)
be_seq_mfit0_preds2[be_seq_mfit0_preds2$collection_date==(today+7)&
                      be_seq_mfit0_preds2$variant=="501Y.V3 (Brazilian)",]
#            variant collection_date_num      prob       SE df asymp.LCL asymp.UCL collection_date
# 501Y.V3 (Brazilian)                18740 0.05038343 0.008239952 NA 0.03423342 0.06653344      2021-04-23
...
#            variant collection_date_num      prob       SE df asymp.LCL asymp.UCL collection_date
# 2241 501Y.V1+V2+V3               18733 0.9780637 0.001529201 NA 0.9750666 0.9810609      2021-04-16

# estimated proportion of one of the three VOCs among new infections today (counted one week before lab diagnosis)
be_seq_mfit0_preds2[be_seq_mfit0_preds2$collection_date==(today+7)&
                      be_seq_mfit0_preds2$variant=="501Y.V1+V2+V3",]
#            variant collection_date_num      prob       SE df asymp.LCL asymp.UCL collection_date
# 2241 501Y.V1+V2+V3               18740 0.9854914 0.001136623 NA 0.9832636 0.9877191      2021-04-23
...
be_seq_mfit0_preds2_subs = be_seq_mfit0_preds2[be_seq_mfit0_preds2$collection_date>as.Date("2021-01-01")&
                                                 be_seq_mfit0_preds2$variant=="501Y.V1+V2+V3",]
# >50% by 12th of February [12th Feb - 13th Feb] 95% CLs
...
# >75% by 3d of March [2nd Mar - 3d March] 95% CLs
...
# >90% by 21st of March [20th March - 22nd of March] 95% CLs
...
# >50% by 5th of Feb [5th Feb - 6th Feb] 95% CLs
...
# >75% by 24th of February [23d Feb - 24th Feb] 95% CLs
...
# >90% by 14th of March [13th March - 15th of March] 95% CLs
...
be_basplusact_seq_mfit0 = nnet::multinom(variant ~ ns(collection_date_num, df=1), weights=count, data=be_basplusactseqdata_long, 
                                         subset=be_basplusactseqdata_long$variant!="501Y.V1+V2+V3"&
                                           be_basplusactseqdata_long$collection_date>=as.Date("2021-01-20"), 
                                         maxit=1000)
...
qplot(data=data_cases_BE_NL[data_cases_BE_NL$variant!="totaal",], 
  ...
  ylab("Aantal bevestigde infecties per dag") + xlab("") + ggtitle("Geschatte aantal nieuw bevestigde infecties door de\nBritse, Zuid-Afrikaanse en Braziliaanse varianten") +
  scale_x_continuous(breaks=as.Date(c("2020-03-01","2020-04-01","2020-05-01","2020-06-01","2020-07-01","2020-08-01","2020-09-01","2020-10-01","2020-11-01","2020-12-01","2021-01-01","2021-02-01","2021-03-01","2021-04-01","2021-05-01")),
                     labels=c("M","A","M","J","J","A","S","O","N","D","J","F","M","A","M")) +
  coord_cartesian(xlim=c(as.Date("2020-09-01"),NA), expand=c(0,0)) +
  labs(tag = tag) +

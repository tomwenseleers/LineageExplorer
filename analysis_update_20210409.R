...
dat="2021_04_09" # desired file version for Belgian data (date/path in //data)
...
head(be_seqdata)
range(be_seqdata$collection_date) # "2020-12-03" "2021-04-01"
...
# 501Y.V1 - wild type 0.06165859 0.05887104 0.06444613
# 501Y.V2 - wild type 0.04733363 0.04232494 0.05234232
# 501Y.V3 - wild type 0.06630655 0.05727198 0.07534112
...
# 501Y.V1 - wild type  0.06166 0.00142 NA 43.353  <.0001 
# 501Y.V2 - wild type  0.04733 0.00256 NA 18.522  <.0001 
# 501Y.V2 - 501Y.V1   -0.01432 0.00248 NA -5.781  <.0001 
# 501Y.V3 - wild type  0.06631 0.00461 NA 14.385  <.0001 
# 501Y.V3 - 501Y.V1    0.00465 0.00453 NA  1.027  0.7338 
# 501Y.V3 - 501Y.V2    0.01897 0.00503 NA  3.771  0.0009 
# 
...
# 501Y.V2 - 501Y.V1   -0.01432 0.00248 NA -5.781  <.0001 
# 501Y.V3 - wild type  0.06631 0.00461 NA 14.385  <.0001 
# 501Y.V3 - 501Y.V1    0.00465 0.00453 NA  1.027  0.3046 
# 501Y.V3 - 501Y.V2    0.01897 0.00503 NA  3.771  0.0002 
# 
# Degrees-of-freedom method: user-specified 
...
#                     estimate asymp.LCL asymp.UCL
# 501Y.V1 - wild type 1.336154  1.318763  1.353775
# 501Y.V2 - wild type 1.249156  1.220093  1.278911
# 501Y.V3 - wild type 1.365664  1.308889  1.424902
...
delta_r_allVOCs
#                               estimate  asymp.LCL  asymp.UCL
# (501Y.V1+V2+V3) - wild type 0.06012881 0.0574301 0.06282753

# implied transmission advantage (assuming no immune evasion advantage of 501Y.V2, if there is such an advantage, transm advantage would be less)
exp(delta_r_allVOCs*4.7) 
#                             estimate asymp.LCL asymp.UCL
# (501Y.V1+V2+V3) - wild type   1.326582  1.309862  1.343515
...
# 501Y.V1 (British)               18726 0.8767035 0.008820566 NA 0.8594155 0.8939915      2021-04-09
...
#            variant collection_date_num      prob       SE df asymp.LCL asymp.UCL collection_date
# 2241 501Y.V1+V2+V3               18726 0.9670036 0.002312469 NA 0.9624712 0.9715359      2021-04-09

# estimated proportion of one of the three VOCs among new infections today (counted one week before lab diagnosis)
be_seq_mfit0_preds2[be_seq_mfit0_preds2$collection_date==(today+7)&
                      be_seq_mfit0_preds2$variant=="501Y.V1+V2+V3",]
#            variant collection_date_num      prob       SE df asymp.LCL asymp.UCL collection_date
# 2241 501Y.V1+V2+V3               18733 0.978091 0.00174919 NA 0.9746626 0.9815193      2021-04-16
...
# >75% by 3d of March [2nd Mar - 4th March] 95% CLs
...
# >90% by 21st of March [19th March - 22nd of March] 95% CLs
...
# >75% by 24th of February [23d Feb - 25th Feb] 95% CLs
...
# >90% by 14th of March [12th March - 15th of March] 95% CLs

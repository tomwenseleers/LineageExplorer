...
if (file.exists("..//set_COVSPECTRUM_credentials.R")) source("..//set_COVSPECTRUM_credentials.R") # set REACT_APP_LAPIS_ACCESS_KEY to access COVSPECTRUM private GISAID part
...
# save.image("~/Github/LineageExplorer/LineageExplorer/environment_4 jan 2023.RData")
# load("~/Github/LineageExplorer/LineageExplorer/environment_4 jan 2023.RData")
...
save.image("~/Github/LineageExplorer/LineageExplorer/environment_15_12_2022.RData")
